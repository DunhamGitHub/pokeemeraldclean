...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
    ...
    TRAINER_SPRITE(BRENDAN, gTrainerFrontPic_Red, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(MAY, gTrainerFrontPic_Leaf, TRAINER_PIC_SIZE),
...
const struct CompressedSpritePalette gTrainerFrontPicPaletteTable[] =
{
    ...
    TRAINER_PAL(BRENDAN, gTrainerPalette_Red),
    TRAINER_PAL(MAY, gTrainerPalette_Leaf),
