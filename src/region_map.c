...
static const u16 sRegionMapPlayerIcon_RedPal[] = INCBIN_U16("graphics/pokenav/region_map/player_icon_red.gbapal");
static const u8  sRegionMapPlayerIcon_RedGfx[] = INCBIN_U8("graphics/pokenav/region_map/player_icon_red.4bpp");
static const u16 sRegionMapPlayerIcon_LeafPal[] = INCBIN_U16("graphics/pokenav/region_map/player_icon_leaf.gbapal");
static const u8  sRegionMapPlayerIcon_LeafGfx[] = INCBIN_U8("graphics/pokenav/region_map/player_icon_leaf.4bpp");
